...
%La capacidad de la memoria RAM y los hz del bus de datos, ya que si la memoria RAM no tiene una capacidad suficiente para soportar la cantidad de información que se utilizará en 
\vspace{0.5cm}
